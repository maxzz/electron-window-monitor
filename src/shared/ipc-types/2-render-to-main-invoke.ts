import { type ManifestForWindowCreatorParams, type GetTlwScreenshotsParams, type Rect4, type TargetPosition, type WindowHighlighterParams } from "@/x-electron/xternal-to-renderer/7-napi-calls";
